                        ...
                        echo '<div class="sous-menu">';
                            echo '<div class="conteneur-sous-menu">';
                                ...
                                echo '<div class="gauche">';
                                    ...
                                    echo '<label class="titre espacement-haut">Concours 2019-2020</label>';
                                    ...
                                    echo '<label class="lien" onclick="window.open(\'reglement.php\', \'_self\');" title="Règlement 2019-2020"><span>Le règlement</span></label>';
                                echo '</div>';
                            echo '</div>';
                        echo '</div>';
                    echo '</li>';
