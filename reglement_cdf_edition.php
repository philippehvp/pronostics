...
<body>
	<?php
		$nomPage = 'reglement_cdf_edition.php';
		...
		echo '<div id="divReglementCDF" class="contenu-page">';
			echo '<textarea name="txtReglement" id="txtReglement">' . $reglement . '</textarea>';
			echo '<input type="button" value="Enregistrer" class="bouton" onclick="enregistrerReglement(5);" />';
		echo '</div>';
	...
	<script>
		$(function() {
			afficherTitrePage('divReglementCDF', 'Règlement CDF');
			retournerHautPage();
