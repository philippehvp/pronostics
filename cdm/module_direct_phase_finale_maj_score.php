<?php
	...
	switch($type) {
		case 'score':
			...
			// Cas particulier : si le score devient NULL, il est nécessaire aussi de le faire pour le score AP
			if($score == 'NULL') {
				if($equipeAB == 'A') {
					// Mise à jour du score AP de l'équipe A
					$ordreSQL =		'	UPDATE			cdm_pronostics_phase_finale' .
					...
					// Mise à jour du score AP de l'équipe B
					$ordreSQL =		'	UPDATE			cdm_pronostics_phase_finale' .
	...
	$ordreSQL =		'CALL cdm_sp_calcul_scores_et_bonus(NULL)';
